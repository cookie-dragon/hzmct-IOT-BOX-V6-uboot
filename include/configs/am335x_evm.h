...
#define CONFIG_EXTRA_ENV_SETTINGS \
	...
	"ethaddr=00:10:20:30:40:50\0" \
	"dispmode=7inch_LCD\0" \
	"rootpath=/root/board/am335/ti-sdk-am335x-evm/targetNFS\0" \
	"ramroot=/dev/ram0 rw ramdisk_size=65536 initrd=${rdaddr},64M\0" \
	"ramrootfstype=ext2\0" \
	"mmcargs=setenv bootargs console=${console} " \
		"dispmode=${dispmode} " \
		"root=${mmcroot} " \
		"rootfstype=${mmcrootfstype} ip=none\0" \
	...
	"netargs=setenv bootargs console=${console} " \
		"dispmode=${dispmode} " \
		"root=/dev/nfs " \
		"nfsroot=${serverip}:${rootpath},nolock rw " \
	...
	"xflash=echo Update Firmware...; "\
		...
		"nand write 0x82000000 0x00780000 ${filesize}; "\
...
#define CONFIG_CMD_CACHE          /*enable L1 cache*/      
